...
// in simulator we redefine to format for pika_shi Developer console
...
{\
	NSString * exceptionName = [@"org.pika_shi." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.pika_shi";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIpika_shiNativeItemNone = -1, 
	UIpika_shiNativeItemSpinner = -2,
	UIpika_shiNativeItemProgressBar = -3,
	
	UIpika_shiNativeItemSlider = -4,
	UIpika_shiNativeItemSwitch = -5,
	UIpika_shiNativeItemMultiButton = -6,
	UIpika_shiNativeItemSegmented = -7,
	
	UIpika_shiNativeItemTextView = -8,
	UIpika_shiNativeItemTextField = -9,
	UIpika_shiNativeItemSearchBar = -10,
	
	UIpika_shiNativeItemPicker = -11,
	UIpika_shiNativeItemDatePicker = -12,
	
	UIpika_shiNativeItemInfoLight = -13,
	UIpika_shiNativeItemInfoDark = -14,
	
	UIpika_shiNativeItemDisclosure = -15,
	
	UIpika_shiNativeItemContactAdd = -16
};
...
/*
 *	TiThreadPerformOnMainThread should replace all pika_shi instances of
