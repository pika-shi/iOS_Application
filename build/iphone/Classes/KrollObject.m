 ...
 * Copyright (c) 2009-2011 by pika_shi, Inc. All Rights Reserved.
...
//@interface pika_shiObject : NSObject
//@end

@interface pika_shiObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[pika_shiObject class]])
		{
			for (NSString *key in [[(pika_shiObject*)o modules] allKeys])
			{
